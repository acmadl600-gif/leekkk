      ...
      `}>
        ...
        <div className="md:flex-1 md:min-w-0">
          ...
          <div id="section-map" className={`relative z-30 w-full ${isMobile ? 'px-4 pb-12 scroll-mt-24' : 'flex-grow h-screen pointer-events-none'}`}>
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-3 md:gap-3 w-full md:max-w-2xl md:ml-auto px-1">
                ...
                return (
                  ...
                  >
                    {isMobile ? (
                      ...
                      <>
                        {/* Desktop: Circular Icon Design (No Square Card) */}
                        <div className="flex flex-col items-center gap-2">
                          <div className={`
                            flex items-center justify-center
                            w-12 h-12 rounded-full 
                            bg-white/10 backdrop-blur-md border border-white/20
                            group-hover:bg-blue-600/20 group-hover:border-blue-400/50 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]
                            transition-all duration-300
                          `}>
                          ...
                          <span className="text-xs font-bold text-slate-400 group-hover:text-white transition-colors">{district.name}</span>
                        </div>
                      </>
                    )}
                  </motion.div>
